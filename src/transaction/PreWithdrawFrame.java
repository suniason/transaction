 ...
 */
public class PreWithdrawFrame extends javax.swing.JFrame {

    /**
     * Creates new form PreWithdrawFrame
     */
    Connection con;
    String uname;
    public PreWithdrawFrame() {
        initComponents();
    }
    
    public PreWithdrawFrame(String uname) {
        initComponents();
        this.uname=uname;
    }
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        try{
            ...
            if(inputpass.equals(password)){
                WithdrawFrame withdraw = new WithdrawFrame(uname);
                withdraw.show();
                dispose();
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreWithdrawFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PreWithdrawFrame().setVisible(true);
            }
        });
    }
